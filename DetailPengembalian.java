public class DetailPengembalian {
    ...
    // Getters and Setters
    public int getId_detail_pengembalian() {
        return id_detail_pengembalian;
    }

    public void setId_detail_pengembalian(int id_detail_pengembalian) {
        this.id_detail_pengembalian = id_detail_pengembalian;
    }
    ...
    public String getKondisi_buku() {
        return kondisi_buku;
    }   

    public void setKondisi_buku(String kondisi_buku) {
        this.kondisi_buku = kondisi_buku;
    }
}